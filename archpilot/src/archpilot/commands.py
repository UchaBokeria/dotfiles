...
KEYBINDINGS: tuple[tuple[str, tuple[tuple[str, str], ...]], ...] = (
    ("editing", (
        ...
        ("ctrl-v then d x y", "delete or yank the rectangle"),
    ...
    ("multiple cursors", (
        ...
        ("w b e 0 $", "move every cursor on its own line"),
        ("i a I A", "type at the start / end of every cursor"),
        ("escape", "leave typing but keep the cursors; again to drop them"),
    )),
